...
function pluginSource(): string {
  return `// Generated by the NemoClaw progressive tool-disclosure performance test.\n\
...
export function writeOpenClawFixture(options: OpenClawFixtureOptions): OpenClawFixtureResult {
  ...
  writeNewFile(
    ...
    `${JSON.stringify(
      {
        name: "nemoclaw-tool-disclosure-performance-test",
        version: "1.0.0",
        private: true,
        type: "module",
  ...
  writeNewFile(
    ...
    `${JSON.stringify(
      {
        id: "nemoclaw-tool-disclosure-performance-test",
        name: "NemoClaw Tool Disclosure Performance Test",
        version: "1.0.0",
        description: "Deterministic synthetic tools for progressive disclosure performance tests.",
