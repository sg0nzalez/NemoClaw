...
/**
 * Public evidence schema for the progressive tool-disclosure benchmark.
 *
...
export const TOOL_DISCLOSURE_SCHEMA_VERSION = "nemoclaw.tool_disclosure_bench.v1" as const;
...
export type BenchmarkPhase = "static-visibility" | "small-control" | "primary" | "large-stress";
...
export interface BenchmarkProtocol {
  ...
  repetitions: Readonly<Record<Exclude<BenchmarkPhase, "static-visibility">, number>>;
...
export interface ToolDisclosureManifest {
  schema_version: ToolDisclosureSchemaVersion;
  benchmark_id: string;
  created_at: string;
