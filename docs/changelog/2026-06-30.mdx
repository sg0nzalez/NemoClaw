...
- Windows setup output is safer to share during troubleshooting.
  ...
  For more information, refer to [Prepare Windows for NemoClaw](/user-guide/openclaw/get-started/prerequisites/windows-preparation) and [Troubleshooting](/user-guide/openclaw/reference/troubleshooting).
