...
- Onboarding and inference validation handle more common setup drift.
  ...
  For more information, refer to [Choose an Inference Provider](/user-guide/openclaw/inference/learn-and-choose/choose-inference-provider), [Prepare Windows for NemoClaw](/user-guide/openclaw/get-started/prerequisites/windows-preparation), and [Troubleshooting](/user-guide/openclaw/reference/troubleshooting).
