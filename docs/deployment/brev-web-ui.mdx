...
- An NVIDIA API key from [inference.nvidia.com](https://inference.nvidia.com/settings/api-keys) if you use the default NVIDIA Cloud provider.
...
1. Go to [inference.nvidia.com](https://inference.nvidia.com).
