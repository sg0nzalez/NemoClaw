...
If an administrator has customized the packaged CDI refresh environment, preparation stops instead of bypassing that policy with default direct generation.
