...
The registered recipe configures the pinned model revision, CPU offload, host networking, `16 GB` of shared memory, and the Nemotron reasoning and tool-call parsers.
Because the service uses host networking and listens on port `8000`, apply the firewall guidance at the top of this page.
