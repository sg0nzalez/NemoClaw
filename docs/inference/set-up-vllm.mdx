...
Express installation and other non-interactive setup treat verified insufficient Docker image-storage or model-cache capacity as advisory, so NemoClaw prints the warning and continues the guarded download.
