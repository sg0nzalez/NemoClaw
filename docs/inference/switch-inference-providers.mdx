...
<AgentOnly variant="openclaw,hermes">
Use [Inference Provider Commands](inference-provider-commands) for provider-specific commands, compatible-endpoint details, and API-family behavior.
</AgentOnly>
<AgentOnly variant="deepagents">
...
- [Inference Provider Commands](inference-provider-commands) for provider-specific model-switch commands and API-family details.
