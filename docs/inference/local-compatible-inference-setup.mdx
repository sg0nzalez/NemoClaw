...
title: "Set Up Local and Compatible Inference"
sidebar-title: "Local and Compatible Setup"
description: "Configure custom compatible endpoints, local vLLM, NVIDIA NIM, and inference timeouts."
description-agent: "Configures custom compatible endpoints, local vLLM, NVIDIA NIM, and inference timeouts for local inference-server and compatible-provider setup."
keywords: ["nemoclaw local inference", "nemoclaw compatible endpoint", "nemoclaw vllm", "nemoclaw nim"]
content:
  type: "task"
---
