...
# Persist runtime defaults only after build-time config and install layers have
# consumed their ARGs. This preserves the image ENV contract without making
# model, messaging, proxy, web-search, or OTEL changes invalidate earlier layers.
