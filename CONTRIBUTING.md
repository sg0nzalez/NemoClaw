...
- Docker (running)
- [uv](https://docs.astral.sh/uv/) (for Python dependency management — install it before running the blueprint setup commands below, since `uv sync` requires the `uv` binary)
