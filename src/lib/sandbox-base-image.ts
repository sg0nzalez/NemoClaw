...
import { createSandboxBaseImageResolutionKey as createSandboxBaseImageResolutionKeyFromSources } from "./sandbox-base-image/resolution-key";
import {
...
export function createSandboxBaseImageResolutionKey(options: ResolveBaseImageOptions): string {
  return createSandboxBaseImageResolutionKeyFromSources(options, {
