...
describe("handlePoliciesState", () => {
  ...
  // taking the resume-skip branch whenever `policyResumeSelection.suppressedAgentRequiredPresetsLive`
  // is true — so the recorded-empty + live-suppressed-preset case cannot
  // silently leave third-party egress active on restricted sandboxes.
