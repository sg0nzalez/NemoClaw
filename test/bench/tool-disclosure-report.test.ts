...
import { renderToolDisclosureMarkdown } from "../../scripts/bench/tool-disclosure/report";
import {
...
} from "../../scripts/bench/tool-disclosure/statistics";
import {
  type BenchmarkPhase,
...
describe("tool-disclosure Markdown report", () => {
  it("renders only gated claims and public-safe evidence fields", () => {
    ...
    expect(markdown).toContain("# Progressive Tool-Disclosure Benchmark");
