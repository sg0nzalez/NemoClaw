...
import type { SanitizedRunEvidence } from "../../scripts/performance/tool-disclosure/execute";
import type { RecordedSyntheticCall } from "../../scripts/performance/tool-disclosure/grading";
import type { ToolDisclosureRecordingEvent } from "../../scripts/performance/tool-disclosure/recorder";
import {
...
} from "../../scripts/performance/tool-disclosure/validation";
...
function buildManifest(
  ...
  return {
    ...
    performance_test_id: "tool-disclosure-complete-evidence-fixture",
...
function recordedCalls(task: SyntheticPerformanceTask | undefined): RecordedSyntheticCall[] {
  return (
